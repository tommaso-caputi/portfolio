export default function Bar() {
    return (
        <div className="pointer-events-none fixed inset-x-0 bottom-0 z-30 mx-auto mb-4 flex origin-bottom h-full max-h-14">
            <div className="bg-white p-2 rounded-full border z-50 pointer-events-auto relative mx-auto 
                            ...
                            transition ease-in-out hover:w-40 duration-1000 delay-150">

                <div className="flex aspect-square cursor-pointer items-center justify-center rounded-full 
                                hover:bg-gray-200 transition-all duration-300" style={{ width: "40px", height: "40px" }}>
                    <a
                ...
                <div className="flex aspect-square cursor-pointer items-center justify-center rounded-full hover:bg-gray-200 transition-all duration-300" style={{ width: "40px", height: "40px" }}>
                    <a
